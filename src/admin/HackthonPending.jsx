...
function HackthonPending() {
    ...
    const fetchApplications = async () => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/applications2Pending`);
            if (!response.ok) {
    ...
    return (
        <div className="admin-container">
            <div className="admin-content">
                <h1 className="admin-heading">Hackathon Pending</h1>
...
export default HackthonPending;