...
function HackthonApproved() {
    ...
    const fetchApplications = async () => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/applications2Approved`);
            if (!response.ok) {
    ...
    const handleApprove = async (id) => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/approve-application2`, {
                method: "PUT",
                headers: {
    ...
    const handleReject = async (id) => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/reject-application2`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    return (
        <div className="admin-container">
            <div className="admin-content">
                <h1 className="admin-heading">Hackathon Approved</h1>
...
export default HackthonApproved;