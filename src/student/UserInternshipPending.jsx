...
function UserInternshipPending() {
    ...
    const fetchApplications = async () => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/applicationsPending`);
    ...
    return (
        <div className="admin-container">
            <div className="admin-content">
                <h1 className="admin-heading">Pending Internship</h1>
...
export default UserInternshipPending;