...
function UserLeaveApproved() {
    ...
    const fetchApplications = async () => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/applications3Approved`);
            if (!response.ok) {
    ...
    return (
        <div className="admin-container">
            <div className="admin-content">
                <h1 className="admin-heading">Approved Leave</h1>
...
export default UserLeaveApproved;
