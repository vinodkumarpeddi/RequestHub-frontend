...
function UserLeaveRejected() {
    ...
    const fetchApplications = async () => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/applications3Rejected`);
            if (!response.ok) {
    ...
    return (
        <div className="admin-container">
            <div className="admin-content">
                <h1 className="admin-heading">Rejected Leave</h1>
...
export default UserLeaveRejected;
